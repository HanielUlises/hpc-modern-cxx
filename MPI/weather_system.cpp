...
int main(int argc, char **argv)
{
    ...
    { 
        ...
        {
            MPI_Recv(&data, sizeof(WeatherData), MPI_BYTE, i, MPI_ANY_TAG, MPI_COMM_WORLD, MPI_STATUS_IGNORE);

            std::cout
                << "Received from station " << data.station_id
    ...
    { // Weather Stations
        ...
        MPI_Send(&data, sizeof(WeatherData), MPI_BYTE, 0, 0, MPI_COMM_WORLD);
